test_that("class dates correct", {
  ...
  expect_equal(monday$exclusions, list(as.Date("2025-10-13")))

  tuesday <- create_class("2025/09/16", 9)
  expect_equal(tuesday$end_date, as.Date("2025/11/25"))
  expect_equal(tuesday$exclusions, list("2025/09/30", "2025/11/11"))
...
test_that("holidays", {
  ...
  get_holidays(2025)
  dates <- readRDS("data/holidays.rds")
  
  expect_equal(length(dates), 11)
})
